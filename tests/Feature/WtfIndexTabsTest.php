...
class WtfIndexTabsTest extends TestCase
{
    ...
    {
        $scss = file_get_contents(resource_path('views/segments/index/WTFIndex/WTFIndex.scss'));
        $blade = file_get_contents(resource_path('views/segments/index/WTFIndex/WTFIndex.blade.php'));
