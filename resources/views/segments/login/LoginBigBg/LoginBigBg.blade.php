            ...
            <div id="login-content">
                @if(!config('app.sms.sign'))
                    <div class="form-group mb-3">
                        <label for="big-login-email">
                            {{__("Email")}}
                        </label>
                        <div class="input-with-icon">
                            <span class="input-icon"><i class="ri-mail-line"></i></span>
                            <input type="email" id="big-login-email" class="form-control" placeholder="{{__("Email")}}" name="email" value="{{old('email')}}" required>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <label for="big-login-password">
                            {{__("Password")}}
                        </label>
                        <div class="input-with-icon">
                            <span class="input-icon"><i class="ri-lock-2-line"></i></span>
                            <input type="password" id="big-login-password" class="form-control" placeholder="{{__('Password')}}" name="password" required>
                        </div>
                    </div>
