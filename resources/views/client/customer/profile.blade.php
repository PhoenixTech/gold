...
@section('title')
    {{__("Customer Dashboard")}} - {{config('app.name')}}
@endsection
            ...
            <div class="col-lg-9" id="tabs-content">
                ...
                @if($isProfileIncomplete)
                    <div id="avisa-alert-profile" class="alert alert-danger mt-4 d-flex align-items-center justify-content-between flex-wrap gap-2 rounded-4">
                        ...
                        <a href="#profile" class="btn btn-sm btn-danger rounded-pill px-3.5 py-1.5 text-white shadow-xs avisa-alert-action">
                ...
                <div class="tab active" id="summary">
                    ...
                    <div class="avisa-hero-card mb-4">
                        <div class="avisa-hero-body">
                            ...
                            <div class="avisa-hero-actions">
                                <a href="#profile" class="btn btn-outline-primary btn-sm rounded-pill px-3.5 py-1.5 avisa-alert-action">
                                    <i class="ri-user-settings-line me-1"></i> {{__("Personal Information")}}
                                </a>
                                <a href="#submit-ticket" class="btn btn-primary btn-sm rounded-pill px-3.5 py-1.5 avisa-alert-action">
                    ...
                    <!-- 6 Stat Summary Cards (3 per row on desktop) -->
                    <div class="row g-3 g-md-4 mb-4">
                        ...
                        <div class="col-lg-4 col-sm-6 col-12">
                            <div class="avisa-summary-stat-card card-credit" onclick="document.querySelector('.tab-control a[href=\'#likes\']')?.click();">
                                <div class="stat-icon-wrapper" style="background: linear-gradient(135deg, #ef4444, #dc2626); color: #fff;">
                        ...
                        <div class="col-lg-4 col-sm-6 col-12">
                            <div class="avisa-summary-stat-card card-ticket" onclick="document.querySelector('.tab-control a[href=\'#bookmarks\']')?.click();">
                                <div class="stat-icon-wrapper" style="background: linear-gradient(135deg, #f59e0b, #d97706); color: #fff;">
                        ...
                        <form action="{{route('client.profile.save')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <button type="submit" class="btn btn-primary rounded-pill px-4 py-2.5 fw-semibold d-inline-flex align-items-center justify-content-center gap-1.5 shadow-xs w-100">
