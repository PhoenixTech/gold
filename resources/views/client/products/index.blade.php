...
@section('title')
    {{$title ?? __('Products')}} - {{config('app.name')}}
@endsection
...
@php
    ...
    $currentCategorySlug = request('category', isset($activeCategory) ? $activeCategory->slug : null);
...
@section('content')
<section class="ProductGridSidebar py-4" id="product-list-view">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-xl-3 d-none d-lg-block">
                <div class="sticky-sidebar-wrapper">
                    @include('client.partials.product-sidebar')
                </div>
            </div>
                        ...
                        <div class="d-flex d-md-none align-items-center gap-2 w-100 justify-content-between">
                            <div class="dropdown flex-grow-1">
                                ...
                                <ul class="dropdown-menu shadow-sm border rounded-3 w-100 py-1">
                                    @foreach($sortOptions as $sortKey => $sortLabel)
                                        <li>
                                            <a class="dropdown-item fs-13 py-2 d-flex align-items-center justify-content-between {{ $currentSort === $sortKey ? 'active bg-primary text-white fw-bold' : '' }}" href="{{ route('client.products', array_merge(request()->except(['sort', 'page']), ['sort' => $sortKey])) }}">
                                                <span>{{ $sortLabel }}</span>
