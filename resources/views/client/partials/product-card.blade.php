<div class="ShivaProductGrid xshop-product-item h-100">
    <div class="product-card card h-100 border-0 shadow-xs hover-lift rounded-4 overflow-hidden d-flex flex-column transition-all bg-white">
        <!-- Card Image Header -->
        <div class="card-img-wrapper position-relative overflow-hidden bg-light">
            ...
            @elseif($product->category)
                <span class="badge bg-warning-subtle text-dark border border-warning-subtle rounded-pill position-absolute top-0 start-0 m-2.5 z-2 fs-11 fw-semibold px-2.5 py-1">
        ...
        <div class="card-body p-3.5 d-flex flex-column flex-grow-1">
            <h5 class="product-title fs-14 fw-semibold mb-2 leading-snug">
            ...
            <div class="mt-auto pt-2 border-top border-light-subtle d-flex align-items-center justify-content-between flex-wrap gap-1">
                ...
                <div class="product-prices d-flex flex-column">
                    @if($isAvailable)
                        ...
                        @endif
                        <span class="price fw-bold text-main fs-17">
                            {{$product->getPrice()}}
                        </span>
                    @else
        ...
        <div class="card-footer bg-transparent border-0 p-3 pt-0">
            ...
            @else
                <a href="{{ route('client.contact') }}"
                   class="btn btn-inquiry btn-sm rounded-pill w-100 fw-semibold py-1.5 d-flex align-items-center justify-content-center gap-1.5"
                   title="{{ __('Contact us for price & order inquiry') }}">
