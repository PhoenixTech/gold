...
@section('content')
<div class="posts-group-view">
    @include('client.partials.parallax-header', ['title' => $group->name, 'subtitle' => $subtitle ?? ''])
            ...
            <div class="col-lg-8 col-xl-9">
                ...
                @else
                    <div class="card border-0 shadow-sm rounded-4 p-5 text-center bg-white">
                        ...
                        <h5 class="fw-bold text-dark mb-1">{{ __("No articles found in this category") }}</h5>
                    </div>
                @endif
            </div>
        </div>
