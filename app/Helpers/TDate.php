...
class TDate
{
    ...
    public function PDate($format, $time = 'now')
    {
        ...
        [$date['year'], $date['mon'], $date['mday']] = self::Ge2Parsi($date['year'], $date['mon'], $date['mday']);
    ...
    public function IDate($format, $time_stamp = 'now')
    {
        ...
        [$d, $D, $j, $l, $S, $F, $m, $M, $n, $t, $L, $o, $Y, $y, $w, $a, $A, $H, $i, $s, $O] = explode('/', date('d/D/j/l/S/F/m/M/n/t/L/o/Y/y/w/a/A/H/i/s/O', $time_stamp));
     ...
     * @param  bool  $shorten  defualt false
    ...
    private function _arabicDate($format, $time_stamp)
    {
        ...
        [$d, $m, $y, $dayname, $monthname, $am] = explode(' ', date('d m Y D M a', $time_stamp));
    ...
    public function Str2Ism($strDate, $format = 'd-m-Y')
    {
        ...
        if ($format == 'd-m-Y') {
            [$d, $m, $Y] = explode('/', date('d/m/Y', strtotime($strDate)));
            extract($this->Ge2Ism($d, $m, $Y));
            $date = "$day-$month-$year";
        } else {
    ...
    public function Ge2Ism($day = 20, $month = 02, $year = 1976)
    {
        ...
        [$_Date['month'], $_Date['day'], $_Date['year'], $_Date['ln'], $_Date['ml']] = [$month, $day, $year, $iln, $ml];
        // result hook
    ...
    public function Parsi2Ge($jy, $jm, $jd)
    {
        ...
        if (self::IsLeapYear($gy - 1) && $gd > 286) {
            $gd--;
        }
        if ($gd > 286) {
            $gd -= 286;
